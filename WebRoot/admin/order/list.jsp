								...
								<tr
									...
									<s:iterator var="o" value="pageBean.list" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
											...
											<td style="CURSOR: hand; HEIGHT: 25px" align="center" >
												<s:property value="#o.name"/>-<s:property value="#o.addr"/>-<s:property value="#o.phone"/>
											</td>
											<td style="CURSOR: hand; HEIGHT: 25px" align="center" >
												<s:if test="#o.payment=='alipay'">
													支付宝支付
												</s:if>
												<s:if test="#o.payment=='bank'">
													银行转账
												</s:if>
												<s:if test="#o.payment=='cod'">
													货到付款
												</s:if>
											</td>
											<td style="CURSOR: hand; HEIGHT: 25px" align="center" >
												...
												<s:if test="#o.state==1">
													已付款-|-<a href="${ pageContext.request.contextPath }/adminOrder_updateState.action?oid=<s:property value="#o.oid"/>"><font color="blue">发货</font></a>
												</s:if>
												<s:if test="#o.state==3">
													已发货
												</s:if>
