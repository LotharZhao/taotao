		...
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminCategory_update.action" method="post">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<textarea name="desc" rows="4" cols="30"><s:property value="model.desc"/></textarea>
					</td>
				</tr>
				<tr>
					<td width="30%" align="center" bgColor="#f5fafe" class="ta_01">
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<input type="text" name="img" value="<s:property value="model.img"/>" id="userAction_save_do_logonName" class="bg"/>
					</td>
				</tr>
